...
/*
 * Abstract class that defines basic feature assembling functions
 */
...
public abstract class FeatureCalcBase {
	...
	public Instance calcInstanceFeatures(DataInstance data) {
		if(isFirstInstance) {
	...
	public Instances calcFeatures(Collection<DataInstance> dataCollection) {
		...
		for(DataInstance data : dataCollection) {
			Instance inst = calcInstanceFeatures(data);
